...
def handle_req(url, body=None):
    ...
    if url == "/index.html":
        return open("index.html",encoding="utf-8").read(), "text/html"
    elif url == "/geocoder_ex2025.html":
        return open("geocoder_ex2025.html",encoding="utf-8").read(), "text/html"
    ...
    # opening some files in binary mode, i.e. `open(..., "br")`.
        ...
        return open("style.css").read(), "text/css"
    elif url == "/geocode.js":
        return open("geocode.js").read(), "text/javascript"
    elif url == "/index.js":
        return open("index.js").read(), "text/javascript"
    ...
    # implement the `submission_to_table`.
        ...
        return open("404.html", encoding="utf-8").read(), "text/html; charset=utf-8"
